                ...
                <div className="mt-3">
                  ...
                  <div className="flex space-x-2 mt-2">
                    ...
                    <Button 
                      variant="outline" 
                      size="sm" 
                      className="bg-[#E60023] hover:bg-[#d00020] text-white hover:text-white border-transparent"
                      onClick={() => window.open(`https://pinterest.com/pin/create/button/?url=${encodeURIComponent(`${window.location.origin}/submit/${currentCollection.slug}`)}&description=${encodeURIComponent(`Contribute to my ${currentCollection.title} message collection!`)}`, '_blank')}
                    >
                      <svg className="h-4 w-4 mr-1" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
